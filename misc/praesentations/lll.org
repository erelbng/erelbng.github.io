...
{{{video(data-autoplay controls loop muted, 60%, ./assets/go_pre.mp4)}}}
...
* Humanoide Roboter
#+REVEAL_HTML: <div style="display: grid; grid-template-columns: 50% 50%;">
{{{video(data-autoplay controls loop muted, 100%, ./assets/failedhumanoid.mp4)}}}

{{{video(data-autoplay controls loop muted, 100%, ./assets/g1.mp4)}}}
