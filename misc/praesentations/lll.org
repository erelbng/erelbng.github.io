...
#+END_NOTES
#+REVEAL_HTML: <div style="display: grid; grid-template-columns: 50% 50%;">
{{{video(data-autoplay loop muted, 80%, ./assets/so100_shadow_sim_full.mp4)}}}

{{{video(data-autoplay loop muted, 80%, ./assets/so100_shadow_real_full.mp4)}}}
...
#+END_NOTES
#+REVEAL_HTML: <div style="display: grid; grid-template-columns: 50% 50%;">
{{{video(data-autoplay loop muted, 80%, ./assets/so100_twin_sim_full.mp4)}}}

{{{video(data-autoplay loop muted, 80%, ./assets/so100_twin_real_full.mp4)}}}

{{{video(data-autoplay loop muted, 80%, ./assets/so100_twin_sim_2_full.mp4)}}}

{{{video(data-autoplay loop muted, 80%, ./assets/so100_twin_real_2_full.mp4)}}}
