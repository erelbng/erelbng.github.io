...
Instead of bending my workflow around a large tool, I decided to build something small that fits exactly what I need, which became [[https://github.com/erelbng/gom][gom]] - "the Git Org Manager".
